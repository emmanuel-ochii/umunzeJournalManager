        ...
        <div class="bg-imageHero">
            <div class="bg-umunzeBrown">
                <div class="content content-full content-top d-flex flex-row">
                    ...
                    <div class="">
                        {{-- <h1 class="pt-3 text-white text-center">Federal College of Education (Technical) Umunze Journal Manager</h1> --}}

                        <h1 class="text-dark text-center" style="font-size:30px;">Multidisciplinary Journal of Education, Research and Development (MUJERD)</h1>
                    </div>
                </div>
            ...
            <div class="content">
              ...
              <div id="main-navigation" class="d-none d-lg-block push">
                <ul class="nav-main nav-main-horizontal nav-main-hover nav-main-dark">
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link " aria-haspopup="true" aria-expanded="false" href="{{ route('journal.create') }}">
                  ...
                  <li class="nav-main-item ms-lg-auto">
                    ...
                    <ul class="nav-main-submenu nav-main-submenu-right">
                      <li class="nav-main-item">
                        <a class="nav-main-link" data-toggle="theme" data-theme="default" href="https://fcetujournals.com/joterd/">
                          <i class="nav-main-link-icon fa fa-circle text-warning"></i>
                          <span class="nav-main-link-name">Joterd</span>
                        </a>
                      </li>
                      <li class="nav-main-item">
                        <a class="nav-main-link" data-toggle="theme" data-theme="assets/css/themes/xwork.min.css" href="https://fcetujournals.com/jahed/">
                          <i class="nav-main-link-icon fa fa-circle text-danger"></i>
                          <span class="nav-main-link-name">Jahed</span>
                        </a>
                      </li>
                      <li class="nav-main-item">
                        <a class="nav-main-link" data-toggle="theme" data-theme="assets/css/themes/xwork.min.css" href="https://fcetujournals.com/mujerd/">
                                        ...
                                        <div class="col-md-8 col-lg-7 d-flex align-items-center">
                                            <div class="px-4 py-3">
                                                ...
                                                <div class="fs-sm mb-2">
                                                    ...
                                                    {{ $journal->created_at }}
                                                    <br /><em class="text-muted">In <a href="" style="font-size: 13px;"
                                                            class="mb-3 btn-outline-quick-links px-1 py-1">{{ $journal->category->category_name }}</em></a>
                                                </div>
