    ...
    <main id="main-container">
        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div
                    class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center ribbon umunze ribbon-bookmark">
                            ...
                            @if (count($categories) > 0)
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        {{-- <td class="d-none d-sm-table-cell"><em class="text-muted">{{ $category->journal->where("cat_id", 2)->count() }}</em> </td> --}}
                                            ...
                                            <div class="btn-group">
                                                <form action="{{ route('category.destroy', $category->id) }}"
                                                    ...
                                                    <a href="{{ route('category.edit', $category->id) }}"
                                                        ...
                                                        data-bs-original-title="Update Category">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
