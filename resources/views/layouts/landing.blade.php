...
<body>
    ...
    <div id="page-container"
        class="enable-page-overlay side-scroll page-header-fixed page-header-dark  page-header-glass main-content-narrow"
        style="min-height: 0;">
                            ...
                            @if (Route::has('login'))
                                <button type="button" class="btn btn-umunze-green">
                                    <a href="{{ route('login') }}" class="text-white"><i
                                            class="fa fa-fw fa-user d-sm-none"></i>
                                        <span class="d-none d-sm-inline-block">Login</span>
                                        <i class="fa fa-fw fa-sign-in-alt opacity-50 ms-1 d-none d-sm-inline-block"></i></a>
                                </button>
                            @endif
                        @else
                            <button type="button" class="btn btn-umunze-green" id="page-header-user-dropdown"
                            ...
                            <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
                                ...
                                <div class="p-2">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{route('manageJournal')}}">
                                    ...
                                    <!-- Toggle Side Overlay -->
                                    <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                                    <a class="dropdown-item" href="{{ route('user.editProfile') }}" data-toggle="layout"
        ...
        <div class="content py-0">
            <div class="row fs-sm">
                <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
                    Powered <i class="fa fa-laptop-code text-danger"></i> by <a class="fw-semibold"
                        href="https://tenece.com" target="_blank">Tenece Professional Services</a>
                </div>
                <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                    <a class="fw-semibold" href="#" target="_blank">FCET Umunze</a> &copy; <span
